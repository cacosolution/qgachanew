    ...
    <div class="container-wrapper">
      ...
      <main>
                ...
                <div class="tab-content" id="myTabContent">
                  ...
                  >
                    ...
                    <div class="notice mt-3">
                      <p class="text-15">
                        <strong>NOTICE:</strong> Send only USDT to this deposit
                        address. Coins will be deposited automatically after 6
                        network confirmations. Smart contract addresses are not
                        supported(Contact us).
                      </p>
                    </div>

                    <div class="text-center confirm-wrap">
                      <button id="confirm-withdraw" class="btn__purple-confirm">
                        Confirm
                      </button>
                    </div>
                  </div>
        ...
        <div id="box-security" class="box-auth signin mt-5">
          ...
          <form>
            <p>
              Please enter the 6-digit verification code sent to your email Or 6
              Digit Authentication code The code is valid for 10 minutes.
            </p>
